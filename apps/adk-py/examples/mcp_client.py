...
from kagenti_adk.a2a.extensions import ToolCallResponse
...
async def run(base_url: str = "http://127.0.0.1:10000"):
    async with httpx.AsyncClient(timeout=30) as httpx_client:
        ...
        mcp_service_spec = kagenti_adk.a2a.extensions.MCPServiceExtensionSpec.from_agent_card(card)
        oauth_spec = kagenti_adk.a2a.extensions.OAuthExtensionSpec.from_agent_card(card)
        tool_call_spec = kagenti_adk.a2a.extensions.ToolCallExtensionSpec.from_agent_card(card)
        ...
        mcp_service_extension_client = kagenti_adk.a2a.extensions.MCPServiceExtensionClient(mcp_service_spec)
        oauth_extension_client = kagenti_adk.a2a.extensions.OAuthExtensionClient(oauth_spec)
        tool_call_extension_client = kagenti_adk.a2a.extensions.ToolCallExtensionClient(tool_call_spec)
        ...
        message = a2a.types.Message(
            ...
            | oauth_extension_client.fulfillment_metadata(
                oauth_fulfillments={
                    key: kagenti_adk.a2a.extensions.OAuthFulfillment(redirect_uri=AnyUrl(oauth.redirect_uri))
