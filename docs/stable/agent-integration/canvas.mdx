...
from kagenti_adk.a2a.extensions.ui.canvas import (
...
Import `CanvasExtensionServer` and `CanvasExtensionSpec` from `kagenti_adk.a2a.extensions.ui.canvas`.
</Step>
...
- [canvas_ui_code_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/canvas_ui_code_agent.py)
- [canvas_ui_test_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/canvas_ui_test_agent.py)
