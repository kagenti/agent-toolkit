...
<Tip>
  **Enable auto-reload during development:** Add `watchfiles` to automatically restart your server when code changes:
  ```bash uv run watchfiles agentstack_agents.agent.run ```
</Tip>
...
[src/agentstack_agents/agent.py](https://github.com/i-am-bee/agentstack-starter/blob/main/src/agentstack_agents/agent.py)
and replace the example with your agent logic.
