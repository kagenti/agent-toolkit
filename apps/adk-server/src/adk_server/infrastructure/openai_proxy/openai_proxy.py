...
from adk_server.domain.models.model_provider import Model, ModelProvider, ModelProviderType
from adk_server.domain.repositories.openai_proxy import (
    IOpenAIChatCompletionProxyAdapter,
    IOpenAIEmbeddingProxyAdapter,
    IOpenAIProxy,
)
from adk_server.infrastructure.openai_proxy.adapters.bedrock import BedrockOpenAIProxyAdapter
from adk_server.infrastructure.openai_proxy.adapters.openai import (
...
from adk_server.infrastructure.openai_proxy.adapters.watsonx import WatsonXOpenAIProxyAdapter
