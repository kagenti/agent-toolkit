...
import kagenti_adk.a2a.extensions.services.llm
...
async def cli(base_url: str, context_id: str) -> None:
    async with httpx.AsyncClient(timeout=30) as httpx_client:
        ...
        llm_spec = kagenti_adk.a2a.extensions.LLMServiceExtensionSpec.from_agent_card(card)
        mcp_spec = kagenti_adk.a2a.extensions.MCPServiceExtensionSpec.from_agent_card(card)
        trajectory_spec = kagenti_adk.a2a.extensions.TrajectoryExtensionSpec.from_agent_card(card)
        trajectory_client = (
            kagenti_adk.a2a.extensions.TrajectoryExtensionClient(trajectory_spec) if trajectory_spec else None
        )
