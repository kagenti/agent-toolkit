...
Check Kagenti framework [`RequirementAgent`](https://github.com/i-am-bee/beeai-framework/blob/3c8f314299ba80d54245999e212f86e43957007c/python/examples/serve/kagenti_platform_await.py#L15) example that leverages the concept.
