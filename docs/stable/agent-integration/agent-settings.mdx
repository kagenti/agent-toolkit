...
Import `SettingsExtensionServer`, `SettingsExtensionSpec`, `SettingsRender`, and field types from `kagenti_adk.a2a.extensions.ui.settings`.
</Step>
...
```python
from kagenti_adk.a2a.extensions.ui.settings import CheckboxField
...
```python
from kagenti_adk.a2a.extensions.ui.settings import CheckboxField, CheckboxGroupField
...
```python
from kagenti_adk.a2a.extensions.ui.settings import OptionItem, SingleSelectField
