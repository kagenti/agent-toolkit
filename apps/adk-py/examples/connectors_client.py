...
from kagenti_adk.a2a.extensions import PlatformApiExtensionClient
...
async def run(
    ...
    async with httpx.AsyncClient(timeout=30) as httpx_client:
        ...
        platform_spec = kagenti_adk.a2a.extensions.PlatformApiExtensionSpec.from_agent_card(card)
        ...
        mcp_extension_client = kagenti_adk.a2a.extensions.MCPServiceExtensionClient(mcp_spec)
