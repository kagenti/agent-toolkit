...
from adk_server.api.auth.auth import (
    ROLE_PERMISSIONS,
    extract_oauth_token,
    get_user_info,
    validate_basic_auth,
...
from adk_server.api.auth.utils import create_resource_uri, get_claims_by_path
from adk_server.api.rate_limiter import RateLimit, UserRateLimiter
...
from adk_server.service_layer.services.a2a import A2AProxyService
from adk_server.service_layer.services.auth import AuthService
from adk_server.service_layer.services.configurations import ConfigurationService
from adk_server.service_layer.services.connector import ConnectorService
from adk_server.service_layer.services.contexts import ContextService
...
from adk_server.service_layer.services.vector_stores import VectorStoreService
...
async def authenticate_oauth_user(
    ...
    try:
        ...
        logger.warning(f"Token validation failed: {e} | expected_aud={expected_aud}")
