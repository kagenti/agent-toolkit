...
from kagenti_adk.a2a.extensions.auth.secrets import (
    SecretDemand,
...
Import `SecretsExtensionServer`, `SecretsExtensionSpec`, `SecretDemand`, and `SecretsServiceExtensionParams` from `kagenti_adk.a2a.extensions.auth.secrets`.
</Step>
