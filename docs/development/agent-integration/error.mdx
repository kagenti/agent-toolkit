...
The Kagenti ADK automatically handles exceptions raised within your agent function and uses the Error extension to report them. **No configuration is required** for standard error reporting.
...
- [error_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/error_agent.py)