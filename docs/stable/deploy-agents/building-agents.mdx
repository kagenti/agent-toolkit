...
- Kagenti ADK installed ([Quickstart](../introduction/quickstart)) and the platform running with `kagenti-adk platform start`
...
If you prefer not to use our starter template, you must ensure your project includes these core components to integrate correctly with the Kagenti ADK platform.
- The SDK Inegration
...
- Git and Platform Metadata
    - The repository must be accessible to the Kagenti ADK orchestrator if you are using the `kagenti-adk add` command via URL.
