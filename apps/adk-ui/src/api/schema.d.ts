...
export interface components {
  schemas: {
    ...
    agentstack_server__api__schema__common__EntityModel____class_getitem_____locals___ModelOutput__1: {
      ...
      /** Origin */
      origin: string;
      source: components['schemas']['NetworkProviderLocation'];
      /** @default api */
    ...
    agentstack_server__api__schema__common__EntityModel____class_getitem_____locals___ModelOutput__4: {
       ...
       */
      name?: string | null;
      registry?: components['schemas']['FileSystemModelProviderRegistryLocation'] | null;
      /** @default online */
      state: components['schemas']['ModelProviderState'];
    ...
    CreateProviderRequest: {
      ...
      /**
       * Origin
       * @description A unique origin of the provider: most often a url. This is used to determine multiple versions of the same agent.
       */
      origin?: string | null;
    };
    /**
     ...
     * Format: uri
     */
    FileSystemModelProviderRegistryLocation: string;
    /**
     * FileType
     * @enum {string}
     */
     ...
     * @enum {string}
     */
    ModelProviderState: 'online' | 'offline';
    /**
     * ModelProviderType
     * @enum {string}
     */
