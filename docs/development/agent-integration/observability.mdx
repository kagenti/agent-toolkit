...
graph LR
    ...
    %% Destinations
    Phoenix[Phoenix<br/>internal: :6006<br/>⚙ Opt-in]
...
Kagenti ADK can integrate with [Arize Phoenix](https://phoenix.arize.com/) for local visualization of agent traces. For cloud-based observability and production monitoring, you can easily integrate [Langfuse](https://langfuse.com/).
...
Phoenix and the OTel collector are **disabled by default**. To enable them, start the platform with:
```sh
