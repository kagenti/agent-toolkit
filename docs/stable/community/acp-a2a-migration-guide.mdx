...
description: "Migrate from ACP (Agent Communication Protocol) to A2A (Agent2Agent) Protocol for Kagenti ADK v0.3.x+."
---

## Quick Migration Checklist

✅ Update dependencies: `acp_sdk` → `kagenti_adk`
...
```toml
dependencies = ["kagenti-adk>=0.4.0"]
```
...
from kagenti_adk.a2a.types import AgentMessage, AgentArtifact
...
@server.agent(
    ...
    description="This is a general-purpose chat assistant prototype built with the Kagenti Framework and powered by Granite.",
    metadata=Metadata(
        annotations=Annotations(
            kagenti_ui=PlatformUIAnnotation(
        ...
        recommended_models=["granite3.3:8b-kagenti"],
        tags=["Granite", "Chat", "Research"], framework="Kagenti", license="Apache 2.0",
...
1. https://github.com/kagenti/adk/blob/main/agents/chat/src/chat/agent.py
2. https://github.com/jenna-winkler/adk-showcase/blob/main/src/adk_agents/agent.py
