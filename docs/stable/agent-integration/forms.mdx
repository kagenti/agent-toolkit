...
One of the most powerful features of the Kagenti ADK is the ability to request structured data from users through interactive forms. Instead of relying on free-form text input, your agent can present users with specific fields, dropdowns, and other form elements to gather precise information.

The Kagenti ADK provides a Form extensions that allows you to collect structured data from users in two ways:
...
from kagenti_adk.a2a.extensions.common.form import FormRender, TextField
from kagenti_adk.a2a.extensions.services.form import (
...
Import `FormServiceExtensionServer`, `FormServiceExtensionSpec`, `FormRender`, and field types from the Kagenti ADK.
</Step>
...
from kagenti_adk.server import Server
from kagenti_adk.a2a.extensions.common.form import FormRender, TextField
from kagenti_adk.a2a.extensions.ui.form_request import (
...
Import `FormRequestExtensionServer`, `FormRequestExtensionSpec`, `FormRender`, and field types from the Kagenti ADK.
</Step>
...
- For form fields and `FormRender`, import from `kagenti_adk.a2a.extensions.common.form`
- For initial forms, import `FormServiceExtensionServer` and `FormServiceExtensionSpec` from `kagenti_adk.a2a.extensions.services.form`
- For dynamic forms, import `FormRequestExtensionServer` and `FormRequestExtensionSpec` from `kagenti_adk.a2a.extensions.ui.form_request`
...
The Kagenti ADK supports various field types for collecting different kinds of structured data:

### TextField
Basic text input fields for collecting strings, names, descriptions, etc.

```python
from kagenti_adk.a2a.extensions.common.form import TextField
...
```python
from kagenti_adk.a2a.extensions.common.form import DateField
...
```python
from kagenti_adk.a2a.extensions.common.form import FileField
...
```python
from kagenti_adk.a2a.extensions.common.form import OptionItem, SingleSelectField
...
```python
from kagenti_adk.a2a.extensions.common.form import OptionItem, MultiSelectField
...
```python
from kagenti_adk.a2a.extensions.common.form import CheckboxField
...
```python
from kagenti_adk.a2a.extensions.common.form import FormRender
...
- [form_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/form_agent.py)
- [form_request_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/form_request_agent.py)
