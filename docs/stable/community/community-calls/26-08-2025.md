...
We've successfully migrated from ACP to A2A protocol, making Kagenti Platform the simple way to build A2A compatible agents.
...
Through the `adk model setup` CLI flow:
...
**Priorities:**
1. Open Canvas functionality [#168](https://github.com/i-am-bee/adk/issues/168)
2. Session history [#623](https://github.com/i-am-bee/adk/issues/623)
3. MCP Support [#780](https://github.com/i-am-bee/adk/issues/780)
4. Support Structured/Form Input in new Form Interface [#982](https://github.com/i-am-bee/adk/issues/982)
5. User configurable agent settings at runtime [#633](https://github.com/i-am-bee/adk/issues/633)
