...
from adk_server.api.schema.files import FileListQuery
...
from adk_server.exceptions import EntityNotFoundError, StorageCapacityExceededError
        ...
        *,
        ...
        async with self._uow() as uow:
            ...
            if extraction.status == ExtractionStatus.PENDING:
                from adk_server.jobs.tasks.file import extract_text
