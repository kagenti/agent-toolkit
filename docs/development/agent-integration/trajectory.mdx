...
Import `TrajectoryExtensionServer` and `TrajectoryExtensionSpec` from `kagenti_adk.a2a.extensions`.
</Step>
...
For a more advanced example, see [trajectory_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/trajectory_agent.py).
